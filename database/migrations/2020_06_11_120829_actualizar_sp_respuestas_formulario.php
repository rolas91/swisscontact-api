...
class ActualizarSpRespuestasFormulario extends Migration
{
    /**
     * Run the migrations.
     *
...
and (concat(p.nombres,\' \',p.apellidos) like \'%',pFiltro,'%\' OR p.documento_identidad like \'%',pFiltro,'%\'  OR p.correo like \'%',pFiltro,'%\'  OR p.telefono like \'%',pFiltro,'%\' )
